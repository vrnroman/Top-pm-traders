...
Handles three bucket formats:
  - Single degree: "37F on ..." or "25C on ..."
  - Range: "28-29F" (2F range, common for US cities)
  - Open-ended lower: "27F or below" / "20C or below"
  - Open-ended upper: "38F or higher" / "30C or higher"
"""
...
def _parse_bucket(question: str, unit: str) -> dict | None:
    ...
    # Single degree: "XXF on" or "XXC on"
